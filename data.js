const ZONES = {
 ...
 "type": "DEEP DIVE",
 "area": "Chablis",
 "note": "개별 climat은 핵심 학습 범위를 넘는 심화. 라벨 이해용."
 },
 {
 ...
 "notes": "스파클링 핵심 학습 항목. 지도 23포인트는 유지하되 프랑스 스파클링 보충으로 이 패널에 수록."
 },
 {
 ...
 "type": "Context",
 "note": "'Cru classé' 용어는 중요하지만 모든 château 명단을 암기할 필요는 없습니다."
 }
 ],
 "syllabusCount": 23
 },
 ...
 "note": "Mosel의 유명 vineyard 예시. 핵심 학습 지명은 Wehlen까지로 보고, 이 밭 이름은 심화로 보세요."
 },
 {
 ...
 "labelTip": "Northern Rhône는 지명만 보고 Syrah/Viognier를, Southern Rhône는 Grenache 중심 블렌드를 떠올리세요. 이 패널에는 Southern France도 함께 포함해 23개 지도 포인트를 유지했습니다.",
 "extraCards": [
 {
 ...
 "type": "Grand Cru 예시",
 "area": "Kaysersberg 인근",
 "note": "Riesling로 자주 언급되는 유명 Grand Cru. 보충 학습."
 },
 {
 "name": "Rangen",
 "type": "Grand Cru 예시",
 "area": "Thann",
 "note": "가파른 화산성 사면으로 유명. 보충 학습."
 }
 ],
 ...
 "note": "Alsace Grand Cru 예시. 개별 Grand Cru명은 핵심 학습 범위를 넘는 보충."
 }
 ],
 "syllabusCount": 2
 },
 ...
 "name": "Ried",
 "type": "Label term",
 "note": "오스트리아 라벨에서 단일 포도밭(vineyard)을 뜻하는 용어로 자주 보입니다. 핵심 학습 범위보다 한 단계 심화."
 }
 ],
 "syllabusCount": 2
 },
 ...
 "group": "신세계",
 "lat": "약 49°N",
 "core": "원본 지도는 BC를 강조. 전체 학습에서는 Okanagan Valley와 함께 Ontario의 Niagara Peninsula도 알아두면 좋다.",
